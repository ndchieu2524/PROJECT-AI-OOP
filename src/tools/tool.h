...
namespace agent::tools {
    ...
    //
    // Thiết kế theo hướng "function-calling": Agent (qua agent::llm::LLMClient)
    // nhận mô tả các Tool (name + description + parametersSchema) để LLM
    // quyết định gọi tool nào, sau đó Harness gọi ToolRegistry::execute(...).
    class Tool {
    public:
